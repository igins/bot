                    ...
                    <div class="card-body">
                        <form method="post" action="#" id="profile-form">
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary">{{__("Записать изменения")}}</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@section('plugins_js')
    <script src="{!! asset("themes/" . Theme::getCurrent() . '/global_assets/js/plugins/forms/selects/select2.full.min.js') !!}"></script>
    <script src="{!! asset("themes/" . Theme::getCurrent() . '/global_assets/js/plugins/forms/styling/uniform.min.js') !!}"></script>
@endsection

@section('js')
    <script src="{!! asset("themes/" . Theme::getCurrent() . '/assets/js/users/show.js') !!}"></script>
@endsection